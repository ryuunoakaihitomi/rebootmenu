 ...
 */
class CmCustomTileWorker(ctx: Context, params: WorkerParameters) : Worker(ctx, params) {
    ...
    companion object {
        ...
        private val publish by lazy {
            if (android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.N &&
                ...
                WorkManager.getInstance(BlackMagic.getGlobalApp())
                    .enqueue(OneTimeWorkRequestBuilder<CmCustomTileWorker>().build())
            }
            true
        }
